...
# 	    tp sales, :index, {:name => {:width => 100}}, :downloads, :revenue, :revenue_per_download, :purchases_per_download
  ...
  class Appstorelookup
    ...
    def self.app_hash_from_itunes_metadata(itunes_metadata)
      ...
      app['description'] = itunes_metadata['description']
      begin
        app['primary_category'] = itunes_metadata['genres'][0]
        app['second_category1'] = itunes_metadata['genres'][1]
        app['second_category2'] = itunes_metadata['genres'][2]
      rescue
      end
